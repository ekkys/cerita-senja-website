    ...
    <section id="topbar" class="d-flex align-items-center fixed-top topbar-transparent">
        <div
            ...
            <i class="bi bi-phone d-flex align-items-center"><span><a
                        href="https://api.whatsapp.com/send/?phone=6285175003172">+62 851 7500 3172</a></span></i>
            <i class="bi bi-clock ms-4 d-none d-lg-flex align-items-center"><span>Mon-Sat: 11:00 - 21 :00
                    WIB</span></i>
        </div>
    </section>
    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparent">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <div class="logo me-auto">
                <h1><a href="index.html">Cerita Senja</a></h1>
        ...
        <div class="hero-container">
            <div id="heroCarousel" data-bs-interval="500" class="carousel slide carousel-fade" data-bs-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <!-- Slide 1 -->
                    <div class="carousel-item active" style="background-image: url(assets/img/slide/hero3.jpg);">
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2 class="animate__animated animate__fadeInDown"><span>Cerita Senja</span> Cafe</h2>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch">
                        ...
                        <div class="content">
                            <h3><strong>Cerita Kami</strong></h3>
                            <p>
                                Kami mulai beroperasi Juni 2023.
                            </p>
